<template>
  <nav class="sidebar" :class="{ active: uiStore.sidebarOpen }">
    ...
    <div class="keyword-section">
      <div class="sidebar-section-label" style="margin-bottom: 8px">
        {{ t("sidebar.search") }}
      </div>
      <input
    ...
    <div class="sidebar-disclaimer">
      <p>
        &copy; 2026 Sebastian Laube –
        <a href="https://www.seblaube.de/about" target="_blank" rel="noopener"
          >www.seblaube.de/about</a
        >
      </p>
      <p>{{ t("sidebar.disclaimer") }}</p>
      <p>
        <a
          href="https://github.com/slaube86/news-reader"
          target="_blank"
          rel="noopener"
          >GitHub</a
        >
...
const groups = [
  ...
  {
    key: "us",
    label: t("sidebar.groupUs"),
    icon: flagUs,
    feeds: [
      { id: "nytimes", label: "NYTimes" },
      { id: "washpost", label: "WashingtonPost" },
      { id: "npr", label: "NPR" },
      { id: "pbsnewshour", label: "PBS NewsHour" },
    ],
  },
  {
    key: "hr",
    label: t("sidebar.groupHR"),
    icon: flagGlobe,
    feeds: [
